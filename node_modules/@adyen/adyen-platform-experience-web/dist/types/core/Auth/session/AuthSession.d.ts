...
export declare class AuthSession {
    private _canSkipSessionRefresh;
    private _refreshPromisorSignal;
    private _sessionIsFrozen;
    private readonly _errorContainer;
    private readonly _specification;
    private readonly _sessionContext;
    private readonly _setupContext;
    private readonly _refreshPromisor;
    private readonly _watchlist;
    readonly freeze: () => void;
    readonly http: (options: import("../../Http/types").HttpOptions) => Promise<any>;
    readonly refresh: (skipSessionRefreshIfPossible?: boolean) => void;
    readonly subscribe: (subscriptionCallback?: import("../../../primitives/reactive/watchlist").WatchListSubscriptionCallback<{
        endpoints: {
