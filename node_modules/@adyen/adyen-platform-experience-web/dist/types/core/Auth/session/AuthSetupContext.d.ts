...
export declare class AuthSetupContext {
    private readonly _session;
    private _endpoints;
    private _revokeEndpointsProxy;
    ...
    constructor(_session: SessionContext<SessionObject, any[]>);
    get endpoints(): {
    ...
    private _fetchSetupEndpoint;
    private _getEndpointsProxy;
    private _getHttpOptions;
    private _resetEndpoints;
}
export default AuthSetupContext;
//# sourceMappingURL=AuthSetupContext.d.ts.map